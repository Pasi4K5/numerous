...
public sealed class TimeUtilTests
{
    ...
    {
        var result = TimeUtil.ParametersToDateTime(now, year, month, day, hour, minute, second);
    ...
    {
        Action act = () => TimeUtil.ParametersToDateTime(
            new(2000, 2, 2, 12, 10, 20),
